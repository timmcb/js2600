...
var TIA = (function () {
    ...
    TIA.prototype.SetColor = function (color) {
        var d = this.Data;
        if (d) {
            var rgb = this.ColorMap[color], r = rgb.R, g = rgb.G, b = rgb.B, ic = this.Index, is = ic;
    ...
    TIA.prototype.GetColor = function (p0, m0, p1, m1, pf, bl) {
        var pfPriority = this.CTRLPF_PFP, pfColor = this.COLUPF;

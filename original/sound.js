function Sound() {
    ...
    ToneGenerator = function(context) {
    ...
    ToneGenerator.prototype.play = function (sound, frequency, volume) {
        if (this.context) {
            ...
            if ((toneChanged || (volumeChanged && this.bufferSource === null)) && volume !== 0) {
                ...
                this.bufferSource.buffer = buffers[sound];
    ...
    this.Frequency0 = 0;
    this.Volume0 = 0;
    this.generator0 = new ToneGenerator(this.context);

    this.Sound1 = 0;
    this.Frequency1 = 0;
    this.Volume1 = 0;
    this.generator1 = new ToneGenerator(this.context);
